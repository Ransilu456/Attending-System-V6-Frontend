...
const navigation = [
    ...
    { name: "WhatsApp", href: "/dashboard/whatsapp", icon: MessageCircle, badge: 'Pro' },
    { name: "Settings", href: "/dashboard/settings", icon: Settings, badge: 'Pro' },
    { name: "Profile", href: "/dashboard/profile", icon: UserCircle, badge: 'Messages' },
];
...
// Extracted Navigation Item component for better performance
...
const Sidebar = memo(({ activeTab, setActiveTab, screenSize }) => {
    return (
        <div className={`${screenSize === 'small' ? 'hidden' : 'flex'} flex-col border-r border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 transition-colors duration-200 shadow-md dark:shadow-slate-900/50`}>
            {/* Logo */}
            ...
            <div className="border-t border-gray-200 dark:border-slate-700 p-2.5">
                <div className="relative">
                    <div className='flex items-center'>
                        <motion.div
                            className="h-9 w-9 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center"
        ...
        return (
            <div className="grid grid-cols-12 gap-4 h-full">
                ...
                >
                    ...
                    <p className="opacity-80 text-sm">Your attendance dashboard is ready for today</p>
                ...
                <motion.div
                    className="col-span-3 bg-white dark:bg-slate-800 rounded-xl p-3 shadow-md dark:shadow-slate-900/50"
                    whileHover={{ y: -5, boxShadow: "0 10px 25px rgba(0, 0, 0, 0.1)" }}
                >
                    <div className="flex items-center justify-between">
                        <h3 className="text-gray-500 dark:text-gray-400 text-xs font-medium">Total Students</h3>
                ...
                >
                    <div className="flex items-center justify-between">
                        <h3 className="text-gray-500 dark:text-gray-400 text-xs font-medium">Present Today</h3>
                ...
                >
                    <div className="flex items-center justify-between">
                        <h3 className="text-gray-500 dark:text-gray-400 text-xs font-medium">Classes Today</h3>
                ...
                >
                    <div className="flex items-center justify-between">
                        <h3 className="text-gray-500 dark:text-gray-400 text-xs font-medium">Messages</h3>
                ...
                {/* Chart section */}
                <motion.div
                    className="col-span-8 bg-white dark:bg-slate-800 rounded-xl p-4 shadow-md dark:shadow-slate-900/50"
                    whileHover={{ y: -5, boxShadow: "0 10px 25px rgba(0, 0, 0, 0.1)" }}
                >
                    <h3 className="text-gray-700 dark:text-gray-300 text-sm font-medium mb-3">Weekly Attendance</h3>
                ...
                {/* Recent activity */}
                <motion.div
                    className="col-span-4 bg-white dark:bg-slate-800 rounded-xl p-4 shadow-md dark:shadow-slate-900/50"
                    whileHover={{ y: -5, boxShadow: "0 10px 25px rgba(0, 0, 0, 0.1)" }}
                >
                    <h3 className="text-gray-700 dark:text-gray-300 text-sm font-medium mb-3">Recent Activity</h3>
                    <div className="space-y-2">
                        {[
                            { text: "Class A attendance marked", time: "10 mins ago", icon: CheckSquare, color: "text-green-500" },
                            { text: "New student registered", time: "1 hour ago", icon: UserCircle, color: "text-blue-500" },
                            { text: "Report generated", time: "3 hours ago", icon: FileText, color: "text-purple-500" },
                            { text: "System updated", time: "Yesterday", icon: Settings, color: "text-gray-500" },
                        ].map((item, i) => (
                            <motion.div
                                key={i}
                            ...
                            >
                                <div className={`p-1.5 rounded-full bg-gray-100 dark:bg-slate-700 ${item.color}`}>
        ...
        >
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                ...
                <motion.div 
                    ...
                    transition={{ 
                        ...
                        scale: { duration: 12, repeat: Infinity, repeatType: "reverse", delay: 2 }
                    }}
                />
            </div>
            ...
            >
                ...
                <div className='w-full bg-white dark:bg-slate-800 h-10 rounded-t-xl flex justify-between items-center px-2 border-b-2 dark:border-gray-300 dark:border-opacity-25 z-10 relative'>
                    ...
                    <div className={`${screenSize === 'small' ? 'hidden' : 'flex'} gap-4`}>
                        {['Dashboard', 'Students', 'Reports', 'Settings'].map((tab) => (
                            <motion.button
                                key={tab}
                                className={`text-sm px-3 py-1 rounded-md ${activeTab === tab.toLowerCase() ? 
                                    'bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 shadow-sm' 
                                    : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700/50 hover:text-gray-900 dark:hover:text-white'
                                }`}
                ...
                <div className={`grid ${screenSize === 'small' ? 'grid-cols-1' : 'grid-cols-[200px_1fr]'} h-[calc(100%-2.5rem)] relative z-10`}>
                    
                    {/* Sidebar */}
                    <Sidebar activeTab={activeTab} setActiveTab={handleTabClick} screenSize={screenSize} />

                    {/* Main dashboard content - always show dashboard */}
                ...
                {/* Add subtle pulsing effects to make the UI feel alive */}
                <motion.div 
            ...
            {/* MacBook bottom part design */}
            <div className="relative mx-auto w-[80%] h-5 bg-gray-300 dark:bg-gray-700 rounded-b-xl"></div>
        </motion.div>
    );
});

// Hero section component - let's enhance it too
const Hero = memo(() => {
    return (
        <section className="w-full pt-10 md:pt-20 pb-5 md:pb-10 relative z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 2xl:max-w-[1600px]">
                {/* Add floating elements */}
                <div className="absolute top-10 right-10 w-20 h-20 rounded-full bg-blue-500/10 dark:bg-blue-500/5 backdrop-blur-md z-0 animate-float-slow"></div>
                <div className="absolute bottom-20 left-20 w-16 h-16 rounded-full bg-indigo-500/10 dark:bg-indigo-500/5 backdrop-blur-md z-0 animate-float-slower"></div>
                
                <div className="text-center max-w-3xl mx-auto mb-8 md:mb-16 2xl:max-w-4xl">
                    <motion.div 
                    ...
                    >
                        Modern Solution for 
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-500 dark:from-blue-400 dark:to-indigo-400"> Education </span>
                        Attendance
                    </motion.h1>
                    <motion.p 
                    ...
                    >
                        A powerful, reliable system to track and manage student attendance with real-time analytics and reporting.
                    </motion.p>
                    <motion.div 
                    ...
                    >
                        ...
                        <Link to='/login'>
                            <motion.button
                                ...
                                whileHover={{ scale: 1.03, boxShadow: "0 0 15px rgba(209, 213, 219, 0.3)" }}
                                whileTap={{ scale: 0.98 }}
                            >
                                Login
...
// Background elements component - enhanced
const BackgroundEffects = memo(() => {
    return (
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            {/* Add a new rotating gradient element */}
            <motion.div
...
const HomePage = () => {
    return (
        <div className="min-h-screen flex flex-col dark:bg-slate-900 bg-gray-50 relative overflow-hidden">
            ...
            {/* Navbar - placeholder div to adjust for fixed navbar height */}
            ...
            {/* MacOs component centered vertically and horizontally */}
